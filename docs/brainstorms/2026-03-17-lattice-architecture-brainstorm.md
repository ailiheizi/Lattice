---
date: 2026-03-17
topic: lattice-decentralized-im-architecture
---

# Lattice 去中心化 IM 架构设计

## 概述

Lattice 是一款去中心化即时通讯系统，用户完全掌控自己的数据。核心理念：自托管、公钥身份、可选加密、灵活信任模型。
...
**架构模式：**
- 分离 FFI 层（`lattice-ffi`）和核心逻辑（`lattice-core`）
